...
private:
  ...
  std::deque<double> angle_history; // Store historical angle values
  static constexpr int history_size = 3; // Size of historical angle window
  ...
  double smoothAngle(const double &ang, bool &use_last);
};
